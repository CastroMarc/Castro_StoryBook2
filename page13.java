...
public class page13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pageThirteen = findViewById(R.id.pageThirteen);
        Intent i = getIntent();
        frogName = i.getStringExtra("frogname");
        pageThirteen.setText(frogName + " the Frog is no longer alone");
    ...
    private void goBackToPage14() {
        Intent i = new Intent(this, page14.class);
        i.putExtra("frogname", frogName);
        startActivity(i);
        finish();
    }
    public void goToPage14(View view) {
        Intent i = new Intent(this, page14.class);
        i.putExtra("frogname", frogName);
        startActivity(i);
        finish();
